        ...
        <CardContent>
          <ScrollArea className="h-64 w-full rounded-md border p-4">
            <div className="space-y-4 text-sm text-muted-foreground">
              ...
              <p>
                Welcome to Jasa Essential. These Terms and Conditions are a binding legal agreement between you and Jasa Essential. By creating an account, you confirm that you have read, understood, and agree to be bound by these terms. If you do not agree, do not register for an account.
              </p>
              ...
              <p>
                All content on this site, including logos, graphics, and text, is the property of Jasa Essential and is protected by copyright and other intellectual property laws. You may not use, copy, or distribute any content without our prior written permission.
              </p>
              ...
              <p>
                To the fullest extent permitted by law, Jasa Essential shall not be liable for any indirect, incidental, or consequential damages arising out of your use of the service.
              </p>
