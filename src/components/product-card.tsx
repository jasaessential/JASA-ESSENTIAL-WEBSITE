  ...
  const CardInner = () => (
    <Card className={cn("group flex h-full w-full flex-col overflow-hidden transition-all duration-300 hover:shadow-lg rounded-xl", className)}>
      ...
      <CardContent className="flex flex-1 flex-col p-3">
          <div className='flex-grow' style={{ minHeight: '2.5rem' }}>
            <h3 className="font-headline text-sm font-bold leading-tight tracking-tight text-foreground line-clamp-2">{product.name}</h3>
          </div>
