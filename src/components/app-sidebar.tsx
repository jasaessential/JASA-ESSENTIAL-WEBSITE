      ...
      const fetchUserShops = async () => {
        ...
        try {
          ...
          const assignedShops = allShops.filter(shop => 
            shop.ownerIds.includes(user.uid)
          );
        ...
        {user && Array.isArray(user.roles) && user.roles.includes('admin') && (
          <SidebarGroup className="bg-gray-100 dark:bg-gray-900 rounded-lg">
              ...
              <SidebarMenu>
                  ...
                  <SidebarMenuItem>
                      <SidebarMenuButton asChild onClick={handleMenuItemClick} isActive={pathname.startsWith('/admin/queries')}>
                  ...
                  <SidebarMenuItem>
                      <SidebarMenuButton asChild onClick={handleMenuItemClick} isActive={pathname.startsWith('/admin/manage-contact')}>
